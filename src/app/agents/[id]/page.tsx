  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="grow w-full max-w-container-container-max mx-auto px-6 md:px-margin-desktop py-12 md:py-20 flex flex-col gap-section-gap">
          ...
          <div className="w-full md:w-2/3 flex flex-col gap-stack-lg pt-4 md:pt-12">
            <div className="flex flex-col gap-stack-sm border-b border-outline-variant/30 pb-6">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <a
                  href="#contact"
                  className="bg-primary hover:bg-inverse-surface text-on-primary text-label-md font-semibold py-3 px-8 rounded transition-colors duration-300 w-full md:w-auto shadow-[0_4px_10px_rgba(0,0,0,0.1)] text-center"
                >
                  Contact Me
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              ...
              <div className="bg-surface-container-low rounded-lg p-6 flex flex-col gap-2">
        ...
        <section id="contact" className="max-w-xl scroll-mt-24">
