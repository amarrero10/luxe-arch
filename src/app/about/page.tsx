    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="grow flex flex-col">
        ...
        <div className="w-full max-w-container-container-max mx-auto px-6 md:px-margin-desktop py-section-gap flex flex-col gap-section-gap">
          ...
          <section className="text-center bg-surface-container-low rounded-xl py-16 px-6">
            ...
            <Link
              href="/"
              className="inline-block bg-primary text-on-primary text-label-md font-semibold px-8 py-4 rounded-lg hover:bg-primary/90 transition-colors"
            >
              Browse Listings
            </Link>
          </section>
